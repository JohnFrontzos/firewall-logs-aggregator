...
public class ToggleWidgetOldActivity extends Activity implements
	...
	public void onClick(View v) {
		int id = v.getId();
        if (id == R.id.toggle_enable_firewall) {
            startAction(1);
        } else if (id == R.id.toggle_disable_firewall) {
            startAction(2);
        } else if (id == R.id.toggle_default_profile) {
            startAction(3);
        } else if (id == R.id.toggle_profile1) {
            startAction(4);
        } else if (id == R.id.toggle_profile2) {
            startAction(5);
        } else if (id == R.id.toggle_profile3) {
            startAction(6);
        }
	}
