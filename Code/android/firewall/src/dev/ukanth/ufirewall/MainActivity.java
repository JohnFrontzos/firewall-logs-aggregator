...
public class MainActivity extends SherlockListActivity implements OnClickListener,
	...
	private void selectFilterGroup() {
        ...
        if (checkedRadioButtonId == R.id.rpkg_core) {
            showApplications(null, 0, false);
        } else if (checkedRadioButtonId == R.id.rpkg_sys) {
            showApplications(null, 1, false);
        } else if (checkedRadioButtonId == R.id.rpkg_user) {
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
        ...
        if (itemId == android.R.id.home) {
            disableOrEnable();
            return true;
        } else if (itemId == R.id.menu_toggle) {
            disableOrEnable();
            return true;
            ...
            showAbout();
            return true;
        } else if (itemId == R.id.menu_setpwd) {
            setPassword();
            return true;
            ...
            showRules();
            return true;
        } else if (itemId == R.id.menu_setcustom) {
            setCustomScript();
            return true;
	...
	public void onClick(View v) {
		...
		int id = v.getId();
        if (id == R.id.label_mode) {
            selectMode();
        } else if (id == R.id.img_wifi) {
            selectActionConfirmation(v.getId());
        } else if (id == R.id.img_3g) {
            selectActionConfirmation(v.getId());
        } else if (id == R.id.img_roam) {
            selectActionConfirmation(v.getId());
        } else if (id == R.id.img_vpn) {
            selectActionConfirmation(v.getId());
        } else if (id == R.id.img_lan) {
            selectActionConfirmation(v.getId());
        } else if (id == R.id.img_invert) {
            selectActionConfirmation(getString(R.string.reverse_all), v.getId());
        } else if (id == R.id.img_reset) {
